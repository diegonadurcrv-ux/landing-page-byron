...
Combinação de Classes: O Tailwind permite empilhar quantas classes você quiser no mesmo elemento (ex: <p class="font-bold text-3xl line-through">), aplicando todos os estilos de uma só vez.
